export default function FooterCard({
  ...
  return (
    <div className="flex my-t sm:mt-4 flex-col gap-y-[10px] sm:gap-y-[10px] md:gap-y-[20px] lg:gap-y-[20px] xl:gap-y-[20px] 2xl:gap-y-[20px] mx-1 sm:mx-2 md:mx-5 lg:mx-10 xl:mx-10 2xl:mx-10">
